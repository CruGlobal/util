...
public abstract class SeamHibernatePersistenceTest extends SeamPersistenceTest
{
	   @Override
	    ...
	    public EntityManagerFactory buildFailoverEntityManagerFactory()
	    {
	        ...
	        properties.put("hibernate.connection.username", "nkopp");
	        properties.put("hibernate.connection.password", "nkopp");
	        properties.put("hibernate.connection.url", "jdbc:oracle:thin:@(DESCRIPTION =(ADDRESS_LIST =(LOAD_BALANCE = YES)(FAILOVER = ON)(ADDRESS = (PROTOCOL = TCP)(HOST = harta9210v)(PORT = 1521))(ADDRESS = (PROTOCOL = TCP)(HOST = harta9310v)(PORT = 1521)))(CONNECT_DATA =(SERVER = DEDICATED)(SERVICE_NAME = psdev.ccci.org)(FAILOVER_MODE =(TYPE = SELECT)(METHOD = BASIC)(RETRIES = 20)(DELAY= 1))))");
//	        properties.put("hibernate.hbm2ddl.auto", "create-drop");
	        ...
	        properties.put("org.ccci.failover.url", ":oracle:thin:@(DESCRIPTION=(ADDRESS_LIST=(ADDRESS=(PROTOCOL = TCP)(HOST = harta9210v)(PORT = 1521)))(CONNECT_DATA =(SERVER = DEDICATED)(SERVICE_NAME = crmdapp.ccci.org)(FAILOVER_MODE=(TYPE = SELECT)(METHOD = BASIC)(RETRIES = 20)(DELAY= 1))))");
	        ...
	        properties.put("org.ccci.failover.username", "dsstest");
	        properties.put("org.ccci.failover.password", "dsstest");
