...
public class ValueExpressionHelper
{
    ...
    /**
     * Source adapted from Seam's enumConverter.  The goal is to get the type to which this component's value
     * is bound.  First, check if the valueExpression provides the type.  For dropdown-like components,
     * this may not work, so check for SelectItems children.
     * 
    ...
    /**
     * return the type for the "value" attribute of the given component, if it exists.
